    ...
    <main className="flex flex-col min-h-screen overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden flex-1 flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          >
            From Resume Scan to<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-cyan-400">Offer-Ready Strategy</span>
          </motion.h1>
          ...
          >
            Get ATS simulation, recruiter eye-path insights, rewrite suggestions, interview conversion prediction,
            and negotiation/application packs in one product flow.
          </motion.p>
